...
- **time_scale**: `float` — Scaling factor for workload’s logical time. Default: `1.0`.
...
- **trace_output**: `str` — Directory that stores the analysis output. Default: `./output/trace_analysis`.
