...
def process_dataset_sharegpt(
    ...
    save_dataset_jsonl(sessioned_prompts, f"sharegpt-dataset.jsonl")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default="promps.jsonl", help="Output file name.")
    ...
    process_dataset_sharegpt(args.path, tokenizer)
