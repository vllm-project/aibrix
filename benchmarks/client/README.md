...
Using a sample workload (generated by [the workload generator](../generator/workload_generator/README.md)) in a client. Turn on `--streaming` to collect fine grained metrics such as `TTFT` and  `TPOT`:
