  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-card border border-border rounded-2xl w-full max-w-[560px] p-8 shadow-2xl">
        ...
        <div className="mb-4">
          <label htmlFor="add-text-title" className="block mb-1.5 text-sm text-foreground/70">
            Title
          </label>
          <input
            id="add-text-title"
        ...
        <div className="mb-6">
          <label htmlFor="add-text-content" className="block mb-1.5 text-sm text-foreground/70">
            Content
          </label>
          <textarea
            id="add-text-content"
