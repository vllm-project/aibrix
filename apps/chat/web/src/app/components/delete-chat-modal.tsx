...
export function DeleteChatModal({ isOpen, onClose, onDelete }: DeleteChatModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center">
      ...
      <div className="relative bg-card border border-border rounded-2xl w-full max-w-[360px] p-6 shadow-2xl">
        ...
        <p className="text-sm text-foreground/50">Are you sure you want to delete this chat?</p>
