      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg border border-gray-200 p-5">
          ...
          <dl className="space-y-3 text-sm">
            ...
            <div className="flex justify-between"><dt className="text-gray-500">Pod Group Size</dt><dd>{data.podGroupSize}</dd></div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-5">
          ...
          <dl className="space-y-3 text-sm">
            ...
            <div className="flex justify-between"><dt className="text-gray-500">Ready Pods</dt><dd>{data.status.readyPods}/{data.status.totalPods}</dd></div>
          </dl>
        </div>
      </div>
