    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[var(--card)] rounded-lg border border-[var(--border)] p-5">
          ...
          <dl className="space-y-3 text-sm">
            <div className="flex justify-between"><dt className="text-[var(--muted-foreground)]">Desired Scale</dt><dd>{data.status.desiredScale}</dd></div>
            <div className="flex justify-between"><dt className="text-[var(--muted-foreground)]">Actual Scale</dt><dd>{data.status.actualScale}</dd></div>
          </dl>
        </div>
      </div>
