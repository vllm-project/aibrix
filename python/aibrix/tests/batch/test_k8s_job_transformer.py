...
def test_k8s_job_extracts_aibrix_metadata():
    ...
    k8s_job["spec"]["template"]["metadata"]["annotations"][
        ...
        '{"job_id":"planner-job-1","planner_decision":{"reservation_id":"reservation-1",'
        '"reservation_resource_deadline":123,"resource_details":[{"resource_type":"deployment",'
    ...
    assert batch_job.spec.aibrix.planner_decision.reservation_id == "reservation-1"
