...
class TOSStorage(PersistentStorage):
    def __init__(self):
        ...
        try:
            ...
            print(
                "TOS client is created. Action succ. code: {}, request_id: {}".format(
                    resp.status_code, resp.headers[bytedtos.consts.ReqIdHeader]
                )
            )
        except bytedtos.TosException as e:
            print(
                "Attempting to create TOS client failed. code: {}, request_id: {}, message: {}".format(
