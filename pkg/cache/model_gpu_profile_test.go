...
var _ = Describe("ModelGPUProfile", func() {
	var (
	...
	It("should Unmarshal formalize the indexes", func() {
	...
	It("should return an error instead of panicking when indexes are shorter than features", func() {
		...
		Expect(err).To(MatchError("profile index size mismatch, got 1, expected 2"))
	...
	It("should return an error instead of panicking when indexes are missing", func() {
		...
		Expect(err).To(MatchError("profile index size mismatch, got 0, expected 2"))
		Expect(signatures).To(BeNil())
	})
	...
	It("should return an error when indexes are longer than features", func() {
		...
		Expect(err).To(MatchError("profile index size mismatch, got 3, expected 2"))
		Expect(signatures).To(BeNil())
	})
})
