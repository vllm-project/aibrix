...
// WithCurrentWeight sets the CurrentWeight field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the CurrentWeight field is set to the value of the last call.
func (b *CanaryStatusApplyConfiguration) WithCurrentWeight(value int32) *CanaryStatusApplyConfiguration {
	b.CurrentWeight = &value
	return b
}
...
func (b *CanaryStatusApplyConfiguration) WithPausedAt(value v1.Time) *CanaryStatusApplyConfiguration {
	b.PausedAt = &value
	return b
}
