...
// WithStableRevision sets the StableRevision field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the StableRevision field is set to the value of the last call.
func (b *CanaryStatusApplyConfiguration) WithStableRevision(value string) *CanaryStatusApplyConfiguration {
	b.StableRevision = &value
	return b
}

// WithCanaryRevision sets the CanaryRevision field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the CanaryRevision field is set to the value of the last call.
func (b *CanaryStatusApplyConfiguration) WithCanaryRevision(value string) *CanaryStatusApplyConfiguration {
	b.CanaryRevision = &value
	return b
}
...
// WithCanaryReplicas sets the CanaryReplicas field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the CanaryReplicas field is set to the value of the last call.
func (b *CanaryStatusApplyConfiguration) WithCanaryReplicas(value int32) *CanaryStatusApplyConfiguration {
	b.CanaryReplicas = &value
	return b
}

// WithStableReplicas sets the StableReplicas field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the StableReplicas field is set to the value of the last call.
func (b *CanaryStatusApplyConfiguration) WithStableReplicas(value int32) *CanaryStatusApplyConfiguration {
	b.StableReplicas = &value
	return b
}
