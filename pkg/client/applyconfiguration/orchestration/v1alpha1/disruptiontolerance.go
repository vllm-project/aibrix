...
// DisruptionToleranceApplyConfiguration represents a declarative configuration of the DisruptionTolerance type for use
// with apply.
type DisruptionToleranceApplyConfiguration struct {
	MaxUnavailable *intstr.IntOrString `json:"maxUnavailable,omitempty"`
}

// DisruptionToleranceApplyConfiguration constructs a declarative configuration of the DisruptionTolerance type for use with
// apply.
func DisruptionTolerance() *DisruptionToleranceApplyConfiguration {
	return &DisruptionToleranceApplyConfiguration{}
}
