					...
					RequestHeaders: &extProcPb.HttpHeaders{
						Headers: &configPb.HeaderMap{
							Headers: []*configPb.HeaderValue{
								...
								{Key: "x-request-id", RawValue: []byte("test-normal-req-1")},
							},
						},
					},
				},
					...
					RequestHeaders: &extProcPb.HttpHeaders{
						Headers: &configPb.HeaderMap{
							Headers: []*configPb.HeaderValue{
								...
								{Key: "x-request-id", RawValue: []byte("test-upload-req-1")},
							},
						},
					},
				},
					...
					RequestHeaders: &extProcPb.HttpHeaders{
						Headers: &configPb.HeaderMap{
							Headers: []*configPb.HeaderValue{
								...
								{Key: "x-request-id", RawValue: []byte("test-download-req-1")},
							},
						},
					},
				},
					...
					RequestHeaders: &extProcPb.HttpHeaders{
						Headers: &configPb.HeaderMap{
							Headers: []*configPb.HeaderValue{
								...
								{Key: ":authority", RawValue: []byte("test.example.com")},
								{Key: "x-request-id", RawValue: []byte("test-error-req-1")},
							},
						},
					},
				},
